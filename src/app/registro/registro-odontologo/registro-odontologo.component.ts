...
import {DialogErrorRegistroPacienteComponent, DialogRegistroPacienteComponent} from '../registro-paciente/registro-paciente.component';
...
/**
 * Componente de registrar odontologo
 */
@Component({
