...
/**
 * Componente de actualizar datos de la secretaria
 */
@Component({
  selector: 'app-actualizar-datos-secretaria',
  templateUrl: './actualizar-datos-secretaria.component.html',
  styleUrls: ['./actualizar-datos-secretaria.component.css']
})
export class ActualizarDatosSecretariaComponent implements OnInit {
  data: any = [];
  ...
  /**
   * Metodo para actualizar los datos de la secretaria
   */
  ...
  /**
   * Cargar los datos de la secretaria en los campos
   */
  cargarData(): void {
    this.usuarioService.getAllUsuario().subscribe((data: any) => {
      ...
      if (error === true){
        this.dialog.open(DialogErrorActualizarSecretariaComponent);
      } else  {
 ...
 */
@Component({
  selector: 'app-dialog-actualizar-secretaria',
  templateUrl: 'dialog-actualizar-secretaria.html',
})
export class DialogActualizarSecretariaComponent {}

@Component({
  selector: 'app-dialog-error-actualizar-secretaria',
  templateUrl: 'dialog-error-actualizar-secretaria.html',
})
export class DialogErrorActualizarSecretariaComponent {}
